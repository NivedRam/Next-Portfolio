export const CONTENT = {
  seo: {
    ...
    keywords:
      "React.js Developer, MERN Stack Developer, Node.js Developer, JavaScript Developer, Full Stack Developer, Web Developer, Frontend Developer, Kochi Developer, Bangalore Developer, Kerala Developer, Karnataka Developer, India Developer",
  },
  navigation: {
    home: "Home",
    about: "About",
  ...
  about: {
    title: "About Me",
    description:
      "I'm a passionate MERN stack developer with expertise in building dynamic, responsive web applications. With experience across multiple companies, I specialize in JavaScript, React, and modern web technologies, delivering high-quality, user-friendly interfaces and scalable solutions.",
    services: {
      fullStack: {
  ...
  contact: {
    ...
    contactInfo: [
      {
        title: "Email",
        value: "nivedchempakam@gmail.com",
        href: "mailto:nivedchempakam@gmail.com",
      },
      {
        title: "Phone",
        value: "+91 8086 432 237",
        href: "tel:+918086432237",
      },
      {
        title: "Location",
        value: "Kochi, India",
